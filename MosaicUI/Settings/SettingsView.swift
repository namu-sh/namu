...
private struct UpdateSettingsContent: View {
    @State private var automaticUpdates: Bool = UserDefaults.standard.bool(forKey: "mosaic.automaticUpdates")
    @State private var checkingForUpdate: Bool = false
    @State private var updateMessage: String?

    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            sectionHeader("Updates", subtitle: "Keep Mosaic up to date")
            ...
            GroupBox {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    .onChange(of: automaticUpdates) { _, newValue in
                        UserDefaults.standard.set(newValue, forKey: "mosaic.automaticUpdates")
                    }
                    ...
                    HStack {
                        Button(action: checkForUpdates) {
                            ...
                            Text(checkingForUpdate ? "Checking..." : "Check for Updates")
                        }
