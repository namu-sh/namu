...
struct CommandPaletteView: View {
    ...
    private var allCommands: [PaletteCommand] {
        builtInCommands + workspaceCommands
    }
...
private final class KeyCaptureView: NSView {
    ...
    override func viewDidMoveToWindow() {
        ...
        if window != nil, monitor == nil {
            MosaicDebug.log("[Mosaic] KeyCaptureView: installing monitor")
            monitor = NSEvent.addLocalMonitorForEvents(matching: .keyDown) { [weak self] event in
                ...
                if consumed.contains(event.keyCode) {
                    MosaicDebug.log("[Mosaic] KeyCaptureView: consumed keyCode=\(event.keyCode)")
                }
...
extension Notification.Name {
    static let toggleSidebar = Notification.Name("mosaic.toggleSidebar")
    static let toggleAIChat = Notification.Name("mosaic.toggleAIChat")
    static let openSettings = Notification.Name("mosaic.openSettings")
    static let selectWorkspace = Notification.Name("mosaic.selectWorkspace")
    static let toggleFindOverlay = Notification.Name("mosaic.toggleFindOverlay")
    static let openBrowserPanel = Notification.Name("mosaic.openBrowserPanel")
}
