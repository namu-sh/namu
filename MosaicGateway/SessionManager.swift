...
/// Represents a connected Mosaic desktop instance.
...
/// Tracks connected Mosaic desktop sessions, heartbeats, and Telegram chat mappings.
public final class SessionManager {
    ...
    private let queue = DispatchQueue(label: "com.mosaic.gateway.sessions", attributes: .concurrent)
