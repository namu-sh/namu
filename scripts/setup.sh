...
echo "==> Symlinking GhosttyKit.xcframework into ghostty/zig-out/..."
mkdir -p "$PROJECT_DIR/ghostty/zig-out"
ln -sfn "$CACHE_XCFRAMEWORK" "$PROJECT_DIR/ghostty/zig-out/GhosttyKit.xcframework"
