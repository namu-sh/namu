...
final class WorkspaceManager: ObservableObject {
    ...
    func createWorkspace(title: String = String(localized: "workspace.default.title", defaultValue: "New Workspace")) -> Workspace {
        ...
        let workspace = makeWorkspace(title: title, order: order)
    ...
    private func makeWorkspace(title: String, order: Int) -> Workspace {
        Workspace(title: title, order: order)
    }
