...
extension Notification.Name {
    static let ghosttyConfigDidReload = Notification.Name("ai.manaflow.mosaic.ghosttyConfigDidReload")
    static let ghosttySurfaceDidClose = Notification.Name("ai.manaflow.mosaic.ghosttySurfaceDidClose")
    static let ghosttyBellDidRing = Notification.Name("ai.manaflow.mosaic.ghosttyBellDidRing")
    static let ghosttyTitleDidChange = Notification.Name("ai.manaflow.mosaic.ghosttyTitleDidChange")
    static let ghosttyPwdDidChange = Notification.Name("ai.manaflow.mosaic.ghosttyPwdDidChange")
    static let ghosttyColorSchemeDidChange = Notification.Name("ai.manaflow.mosaic.ghosttyColorSchemeDidChange")
}
...
private enum GhosttyPasteboard {
    private static let selectionPasteboard = NSPasteboard(
        name: NSPasteboard.Name("ai.manaflow.mosaic.selection")
    )
