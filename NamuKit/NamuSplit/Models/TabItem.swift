...
extension UTType {
    static var namuTabItem: UTType {
        UTType(exportedAs: "com.namu.tabitem")
    }

    static var namuTabTransfer: UTType {
        UTType(exportedAs: "com.namu.tabtransfer", conformingTo: .data)
    }
}

/// Represents a single tab in a pane's tab bar (internal mutable representation)
struct TabItem: Identifiable, Hashable, Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        case id, title, hasCustomTitle, icon, iconImageData, kind
        case isDirty, showsNotificationBadge, isLoading, isPinned
    }
...
extension TabItem: Transferable {
    static var transferRepresentation: some TransferRepresentation {
        CodableRepresentation(contentType: .namuTabItem)
    }
}
...
struct TabTransferData: Codable, Transferable {
    ...
    private enum CodingKeys: String, CodingKey {
        case tab, sourcePaneId, sourceProcessId
    }
    ...
    static var transferRepresentation: some TransferRepresentation {
        CodableRepresentation(contentType: .namuTabTransfer)
    }
}
