...
/// Lightweight AppleScript bridge for Namu.
...
enum AppleScriptSupport {
    ...
    static let createWorkspaceNotification = Notification.Name("namu.applescript.createWorkspace")
    static let listWorkspacesNotification = Notification.Name("namu.applescript.listWorkspaces")
    static let sendKeysNotification = Notification.Name("namu.applescript.sendKeys")
...
extension Notification.Name {
    static let appleScriptCreateWorkspace = Notification.Name("namu.applescript.action.createWorkspace")
    static let appleScriptSendKeys = Notification.Name("namu.applescript.action.sendKeys")
}
